...
class Stripe(ApplePayMixin, BaseClientSidePaymentProcessor):
    ...
    def __init__(self, site):
        ...
        self.max_network_retries = 3 # TODO: Remove this hardcoding after figuring out how to update config tutor prod
    ...
    def _build_payment_intent_parameters(self, basket):
        ...
        return {
            ...
            'metadata': {'order_number': order_number, 'courses': courses_metadata},
        }
